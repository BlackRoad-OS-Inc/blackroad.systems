# ROADMAP — blackroad.systems

> Product roadmap for BlackRoad Systems
...
- [ ] Deploy index.html to blackroad.systems
- [ ] DNS configuration (Gematria or CF)
- [ ] SSL/TLS auto-provisioned
- [ ] RoadCode CI/CD pipeline
- [ ] Mirror to Gitea

**Milestone**: Site live at https://blackroad.systems with < 2s load time.

## Phase 2: Product (Week 3-4)

**Goal**: Real product pages with Stripe integration.

- [ ] Product landing pages for: Fleet Tracker, Heartbeat Monitor, RoadMap (Grafana), Status Dashboard
...
**Milestone**: First paying customer through blackroad.systems.
...
**Milestone**: blackroad.systems is a thriving part of the BlackRoad ecosystem.

---

*BlackRoad OS, Inc. — Pave Tomorrow.*
*Category: monitoring | Products: Fleet Tracker, Heartbeat Monitor, RoadMap (Grafana), Status Dashboard*
